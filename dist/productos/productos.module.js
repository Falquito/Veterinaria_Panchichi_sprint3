...
const depositos_service_1 = require("../depositos/depositos.service");
...
exports.ProductosModule = ProductosModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [productos_service_1.ProductosService, depositos_service_1.DepositosService],
        imports: [typeorm_1.TypeOrmModule.forFeature([producto_entity_1.Producto, categoria_entity_1.Categoria, deposito_entity_1.Deposito])],
    })
], ProductosModule);
